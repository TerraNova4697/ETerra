...
class PreferencesManager @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    val userPreferencesFlow: Flow<UserPreferences> = context.dataStore.data
        ...
        .map { preferences ->
            ...
            UserPreferences(userName, gender, email, mobileNumber, imageUrl)
        }

    suspend fun saveUser(name: String, gender: String, email: String, mobileNumber: String, imageUrl: String) {
